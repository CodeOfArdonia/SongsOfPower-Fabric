...
public class SphereModel<T extends Entity> extends EntityModel<T> {
    public static final EntityModelLayer LAYER_LOCATION = new EntityModelLayer(new Identifier(SongsOfPower.MOD_ID, "sphere"), "main");
    ...
    public static TexturedModelData createBodyLayer() {
        ...
        ModelPartData gaping_void = partdefinition.addChild("gaping_void", ModelPartBuilder.create(), ModelTransform.pivot(0.0F, 16.0F, 0.0F));
